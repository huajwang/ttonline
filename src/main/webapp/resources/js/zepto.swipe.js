...
$.fn.swipeSlider = $.fn.swipeSlide = function(e) {
    $(this.children()[0]).addClass("swiper-wrapper"),
    $(this.children()[0]).children().each(function(e, a) {
        $(a).addClass("swiper-slide")
    }),
    e.slidesPerView = e.visibleSlides || 1,
    e.initialSlide = e.first || 0,
    e.onSlideChangeEnd = e.afterChange || new Function,
    0 != e.bulletNavigation && ($(this).append('<div class="swiper-pagination"></div>'), e.pagination = $(this).find(".swiper-pagination")[0]),
    1 == e.slidesPerView && "undefined" == typeof e.loop && (e.loop = !0),
    e.direction = e.vertical ? "vertical": "horizontal",
    e.autoPlay ? 1 == e.autoPlay && (e.autoplay = 3e3) : e.autoplay = 0,
    this.swiper(e)
}; //@ sourceURL=gomeUI/comp/zepto.swipe.js
