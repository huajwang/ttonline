...
(function(window, undefined){
	...
	TouchSlider.prototype={
		...
		_default: {
			...
			'auto': 0, //是否自动开始，负数表示非自动开始，0,1,2,3....表示自动开始以及从第几个开�?
		...
		//根据class、标签获取parent下的节点�? getElementsByClass
		...
		isIE:function(){ //不包括IE9+，IE9开始支持W3C绝大部分事件 方法�?
			return !-[1,];
		},
		//设置OR获取节点样式
		css:(function(){
		...
		setup: function(){
			...
			if(this.length<2)return;//小于2不需要滚�?
		...
		slide:function(index, speed){
			...
			var el=this.element, timer=null,
				...
				_this=this,
				t=0, //动画开始时�?
				b=parseInt(style[direction]) || 0, //初始�?
				c=-index*this[size]-b, //变化�?
		...
		_move:function(e){
			...
			}else this.scrolling=0;//设置为摒弃标�?0
		},
		_end:function(e){
