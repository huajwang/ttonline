...
s.linkInternalFilters = "javascript:,m.gome.com.cn"
...
//			s.campaign=s.getQueryParam('cmpid');
    ...
    if (!s.prop51)
        s.prop51 = s.getQueryParam('kp');
    /* Set Internal Search Event */
    ...
    /* Track Previous Page of Shopping Cart */
    s.prop6 = s.getPreviousValue(s.prop4, 'gpv_p6', 'scAdd');

    /* Time Parting */
    s.prop9 = s.getTimeParting('h', '8'); // Set hour
    s.prop10 = s.getTimeParting('d', '8'); // Set day
    s.eVar9 = s.prop9;
    s.eVar10 = s.prop10;

    /* Set New or Repeat Visits */
    s.prop8 = s.getNewRepeat(365, 's_getNewRepeat');
    s.eVar8 = s.prop8;
