var require = (function(){
    if(typeof requireConfig == 'undefined' && typeof __require != 'undefined'){
        requireConfig = {
            baseUrl: '',
            version: '',
            deps: {},
        }
        __require.requireArray.forEach(function(config,idx){
                ...
                downloadQueue.push({
                    ...
                    'path': (function(){
                            if(file.match(/\.css\.js$/)){
                                return file.replace(/\.css\.js$/,'.'+deps[file]+'.css.js');
                            }else{
                                return file.replace(/\.js$/,'.'+deps[file]+'.js');
                            }
                        })(),
                    'type': 'download'
                })
