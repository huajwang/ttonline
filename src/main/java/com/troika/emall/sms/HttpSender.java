...
public class HttpSender {
	...
	public static void sendContent(String mobile,String content){
		boolean needstatus = true;// 是否需要状态报告，需要true，不需要false
		String product = null;// 产品ID
		String extno = null;// 扩展码
		try {
			String returnString = HttpSender.batchSend(PropertyConstant.SMS_URL, PropertyConstant.SMS_ACCOUNT, PropertyConstant.SMS_PWD, mobile, content, needstatus, product, extno);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
